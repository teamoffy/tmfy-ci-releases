...
products='aws-lc bun graalvm zlib-ng postgres mysql valkey clickhouse pebble typesense zstd libgit2 playwright-browsers sqlite-vec llama-embedding k3s k3s-system flatcar flatcar-zfs-sysext stacks'
